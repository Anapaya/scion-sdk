...
use crate::{
    dispatcher::Dispatcher, tunnel_gateway::metrics::TunnelGatewayDispatcherMetrics,
    tunnel_gateway_deprecated::state::SharedTunnelGatewayState,
};
...
/// Tunnel gateway dispatcher.
#[derive(Debug, Clone)]
pub struct TunnelGatewayDispatcherDeprecated<T>
where
...
impl<T> TunnelGatewayDispatcherDeprecated<T>
where
    T: for<'de> Deserialize<'de> + Token,
{
...
impl<T> Dispatcher for TunnelGatewayDispatcherDeprecated<T>
where
