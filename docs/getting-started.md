...
```rust reference="@sdk/scion-stack/examples/udp_echo.rs" title="scion-stack/examples/udp_echo.rs"
```
...
```rust reference="@sdk/scion-stack/examples/udp_echo.rs#start-pocketscion" title="udp_echo.rs"
```
...
```rust reference="@sdk/scion-stack/examples/common/mod.rs#build-stack" title="examples/common/mod.rs"
```
...
```rust reference="@sdk/scion-stack/examples/udp_echo.rs#echo-server" title="udp_echo.rs"
```
...
```rust reference="@sdk/scion-stack/examples/udp_echo.rs#client" title="udp_echo.rs"
```

```rust reference="@sdk/scion-stack/examples/udp_echo.rs#ping" title="udp_echo.rs"
```
...
```rust reference="@sdk/scion-stack/examples/udp_paths.rs#fetch-paths" title="udp_paths.rs"
```
...
```rust reference="@sdk/scion-stack/examples/udp_paths.rs#send-each" title="udp_paths.rs"
```
