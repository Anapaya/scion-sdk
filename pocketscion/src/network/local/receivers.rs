...
///
/// NOTE: Receivers **MUST NOT** try to acquire a write lock on the `SharedPocketScionState` in
/// their `receive_packet` method, as the network simulation is holding this lock during dispatch.
