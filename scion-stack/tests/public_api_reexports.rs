...
use scion_stack::{
    endhost_api_client, endhost_api_discovery_models, hickory_resolver, reqwest,
    scion_sdk_quic_scion, scion_sdk_reqwest_connect_rpc, sciparse, url, x25519_dalek,
};
...
fn reexports_are_reachable() {
    ...
    type _TokenSource = dyn scion_sdk_reqwest_connect_rpc::token_source::TokenSource;
    type _EndhostApiClient = dyn endhost_api_client::client::EndhostApiClient;
    type _EndhostApiGroup = endhost_api_discovery_models::EndhostApiGroup;
    type _BoxedSocketError = scion_sdk_quic_scion::socket::BoxedSocketError;
}
