...
use ipnet::IpNet;
use rand::TryRng;
use scion_connect_rpc::client::{CrpcClient, CrpcClientError, RemoteEndpoint};
...
pub struct EdgeTunnelOptions {
    ...
    pub control_client_quic_config: Option<scion_quic::quic::config::QuicConfig>,
...
impl EdgeTunnelOptionsBuilder {
    ...
    pub fn control_client_quic_config(
        mut self,
        control_client_quic_config: Option<scion_quic::quic::config::QuicConfig>,
    ) -> Self {
