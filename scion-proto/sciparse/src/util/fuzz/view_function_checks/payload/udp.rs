...
pub fn exec_every_view_function(view: &mut UdpDatagramView) {
    ...
    view.set_src_port(black_box(view.src_port()));
    view.set_dst_port(black_box(view.dst_port()));
    view.set_length(black_box(view.length()));
